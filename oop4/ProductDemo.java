	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(menuNo == 1) {
				...
				// TODO 서비스의 전체 상품 조회기능 실행
				service.printAllProduct();
				
			} else if(menuNo == 2) {
				System.out.println("[상품 입고 처리]");
				// TODO 서비스의 상품 입고 기능 실행
				// TODO 신규 상품인 경우 할인율 입력받지 않음
				// TODO 이월 상품인 경우 할인율 입력받음
				// TODO 기존 상품 추가 등록인 경우 상품이름과 입고량만 입력받음
				System.out.println("==================================");
				System.out.println("1.신규상품	2.이월상품	3.재고추가");
				System.out.println("==================================");
				
				System.out.print("입고 처리할 번호를 선택하세요 : ");
				int stockMenuNo = sc.nextInt();
				
				if(stockMenuNo == 1) {
					// 상품명, 제조사, 카테고리, 가격, 입고량을  입력받아서 입고처리
					// TODO 서비스의 상품 입고기능 실행
				...
				System.out.println("==============================================================");
				System.out.println("1.이름검색	2.제조사	3.카테고리	4.가격");
				System.out.println("==============================================================");
